...
anyTokenParser :: T.Text -> [(LT.TokenType, a)] -> Parser a
anyTokenParser e [] s x = Left $ E.Error
                          (e)
                          (filename s)
                          (line s)
                          (column s)
...
anyTokenParser e ((t, c):cs) s x = rTokenParser t c s x <!> anyTokenParser e cs s x
